...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || '08_05_H_E_R_M_I_T_WDCZBER',
    ...
    BOT_NAME: process.env.BOT_NAME || '𝐷𝐴𝑉𝐼𝐿 ♡⁠‿⁠♡',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐷𝐴𝑉𝐼𝐿 ♡⁠‿⁠♡;𝐷𝐴𝑅𝐸  𝐷𝐴𝑉𝐼𝐿 ♡⁠‿⁠♡;972528277755;https://i.imgur.com/6oRG106.jpeg',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ʜᴇʀᴍɪᴛ;ᴀᴅɪᴛʜyᴀɴ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,

    STICKER_DATA: process.env.STICKER_DATA === undefined ? '𝐷𝐴𝑅𝐸  𝐷𝐴𝑉𝐼𝐿 ♡⁠‿⁠♡;𓆩‎ঘুমপ্রেমী𓆪' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '919832962298,0',
